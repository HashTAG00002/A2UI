"""taskvm_bench.evaluation.aggregation — failure taxonomy + the report schema.
...
from taskvm_bench.benchmark.registry import DIAGNOSTIC_ONLY_CONDITIONS
from taskvm_bench.evaluation.statistics import mean, percentile, safe_div, wilson_ci
