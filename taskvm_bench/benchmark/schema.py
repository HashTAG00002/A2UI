"""taskvm_bench.benchmark.schema — the frozen data contract of the final benchmark.

This is NOT the legacy ``CanonicalTaskGraph`` stack (that lives on in
``taskvm_bench/benchmark/fixtures.py`` for the still-supported legacy workspace UI;
