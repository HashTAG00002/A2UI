...
from taskvm.baselines.base import _ok, register
from taskvm.harness.observations import TraceFixture
from taskvm.task_state.entity_binding import OPERATOR_REGISTRY
...
def discover(trace: TraceFixture, observed_entity_ids: dict[str, set[str]],
    ...
    for app, ids in observed_entity_ids.items():
        ...
        from taskvm.harness.replay_engine import parse_dom_entities
