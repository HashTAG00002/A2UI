"""taskvm.evaluation.harness — the system conditions (part 1: contracts,
...
from taskvm.evaluation.actors import (
    TemplateCUA, TemplateModelPort, parse_goal_program, parse_visible_kv,
)
from taskvm.evaluation.world import ExternalEvent
from taskvm.benchmark.schema import InjectionKind
...
def make_harness(condition: "Condition | str", *, spec=None):
    ...
    if not isinstance(condition, Condition):
        from taskvm.benchmark.registry import condition_of
