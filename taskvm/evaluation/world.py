"""taskvm.evaluation.world — the deterministic evaluation world.

The exam room (handoff 07 §权限隔离): one :class:`BenchmarkWorld` per
trial, built from a frozen :class:`taskvm.benchmark.schema.TaskSpec`.
...
from taskvm.benchmark.schema import Injection, InjectionKind, TaskSpec
